...
- Backend image tagi `backend/helm/values.yaml`da; agent tagi `chatbot/helm/values.yaml`da saqlanadi. Har bir application CD o'z repo values faylini standart `GITHUB_TOKEN` bilan yangilaydi.
